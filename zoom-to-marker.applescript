...
tell application "System Events"
    tell process "Logic Pro"
        ...
        my doStep(kcSetLocatorsByMarker, "Set locators by marker") -- Set locators to nearest marker range
        ...
        my doStep(kcSelectInLocators,    "Select within locators") -- Re-select to get clean selection
        my doStep(kcHideShowTracks,      "Hide unselected tracks") -- Unhide tracks that have content
        my doStep(kcToggleHideView,      "Toggle hide view")       -- Show hidden track view
        my doStep(kcToggleCycle,         "Disable cycle")          -- Disable cycle mode
